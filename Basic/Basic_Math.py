...
if __name__ == "__main__":
    ...
    for i in index_list:
        try:
            code = bu.iterator(url_list, i, model, "Math")
            ...
            if i < 85:
                ...
                defects4j compile > /home/lanweifrj/Test_Total/Math_buggy/results/basic/result_{i}.txt

                defects4j test >> /home/lanweifrj/Test_Total/Math_buggy/results/basic/result_{i}.txt
                """
            else :
                configure_script = f"""
                rm -rf /home/lanweifrj/Test_Total/Math_buggy/Math_{i}_buggy
            ...
            if result_err:
                ...
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Math_buggy/errors/basic/error_log_{i}.txt", "w") as f:
                    f.write(result_err)
            ...
            if i < 85:
                ...
                defects4j compile > /home/lanweifrj/Test_Total/Math_fixed/results/basic/result_{i}.txt

                defects4j test >> /home/lanweifrj/Test_Total/Math_fixed/results/basic/result_{i}.txt
                """
            else:
                configure_script = f"""
                rm -rf /home/lanweifrj/Test_Total/Math_fixed/Math_{i}_fixed
            ...
            if result_err:
                print("No." + str(i) + " error.\n")
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Math_fixed/errors/basic/error_log_{i}.txt", "w") as f:
                    f.write(result_err)

            print("fixed done.")

        except:
            with open(f"/home/lanweifrj/Test_Total/Math_buggy/errors/basic/fatal_log_{i}.txt", "w") as f:
