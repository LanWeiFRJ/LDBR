...
if __name__ == "__main__":
    ...
    for i in index_list:
        try:
            ...
            defects4j compile > /home/lanweifrj/Test_Total/JxPath_buggy/results/basic/result_{i}.txt

            defects4j test >> /home/lanweifrj/Test_Total/JxPath_buggy/results/basic/result_{i}.txt
            """
            ...
            if result_err:
                ...
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/JxPath_buggy/errors/basic/error_log_{i}.txt", "w") as f:
                    f.write(result_err)
            ...
            defects4j compile > /home/lanweifrj/Test_Total/JxPath_fixed/results/basic/result_{i}.txt

            defects4j test >> /home/lanweifrj/Test_Total/JxPath_fixed/results/basic/result_{i}.txt
            """
            ...
            if result_err:
                print("No." + str(i) + " error.\n")
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/JxPath_fixed/errors/basic/error_log_{i}.txt", "w") as f:
                    f.write(result_err)

            print("fixed done.")

        except:
            with open(f"/home/lanweifrj/Test_Total/JxPath_buggy/errors/basic/fatal_log_{i}.txt", "w") as f:
