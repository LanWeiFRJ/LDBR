...
if __name__ == "__main__":
    ...
    for i in index_list:
        try:
            code = bu.iterator(url_list, i, model, "Codec")
            ...
            if result_err:
                ...
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Codec_buggy/errors/basic/error_log_{i}.txt", "w") as f:
                    f.write(result_err)
            ...
            if result_err:
                print("No." + str(i) + " error.\n")
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Codec_fixed/errors/basic/error_log_{i}.txt", "w") as f:
                    f.write(result_err)

            print("fixed done.")

        except:
            with open(f"/home/lanweifrj/Test_Total/Codec_fixed/errors/basic/fatal_log_{i}.txt", "w") as f:
