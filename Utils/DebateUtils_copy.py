...
def generate_prompt(html_content, repo, state_code, code=None):
    """
...
def iterator(url_list, i, model1, model2, repo):
    model_start = model1
    ...
    print("fetch done")
    prompt = generate_prompt(html_content, repo, state_code=1)
