...
if __name__ == "__main__":
    ...
    for i in index_list:
        try:
            _code3, response1, response2, response3, _response1, _response2, _response3 = du.iterator(url_list, i, model1, model2, "Lang")
            # 用正则表达式匹配“public class ***”
            class_name = du.re.search(r"(?<=\bpublic\sclass\s)[A-Z][a-zA-Z0-9_]*", _code3, du.re.DOTALL).group(0)

            configure_script = f"""
            rm -rf /home/lanweifrj/Test_Total/Lang_buggy/Lang_{i}_buggy
            ...
            defects4j compile > /home/lanweifrj/Test_Total/Lang_buggy/results/debate/result_{i}.txt

            defects4j test >> /home/lanweifrj/Test_Total/Lang_buggy/results/debate/result_{i}.txt
            """
            ...
            if result_err:
                ...
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Lang_buggy/errors/debate/error_log_{i}.txt", "w") as f:
                    f.write(result_err)
            ...
            configure_script = f"""
            rm -rf /home/lanweifrj/Test_Total/Lang_fixed/Lang_{i}_fixed
            ...
            defects4j compile > /home/lanweifrj/Test_Total/Lang_fixed/results/debate/result_{i}.txt

            defects4j test >> /home/lanweifrj/Test_Total/Lang_fixed/results/debate/result_{i}.txt
            """
            ...
            if result_err:
                print("No." + str(i) + " error.\n")
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Lang_fixed/errors/debate/error_log_{i}.txt", "w") as f:
                    f.write(result_err)

            print("fixed done.")

        except:
            with open(f"/home/lanweifrj/Test_Total/Lang_buggy/errors/debate/fatal_log_{i}.txt", "w") as f:
