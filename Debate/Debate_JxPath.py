...
if __name__ == "__main__":
    ...
    for i in index_list:
        try:
            _code3, response1, response2, response3, _response1, _response2, _response3 = du.iterator(url_list, i, model1, model2, "JxPath")
            ...
            defects4j compile > /home/lanweifrj/Test_Total/JxPath_buggy/results/debate/result_{i}.txt

            defects4j test >> /home/lanweifrj/Test_Total/JxPath_buggy/results/debate/result_{i}.txt
            """

            script_path = f"/home/lanweifrj/Test_Total/JxPath_buggy/scripts/configure_script_{i}.sh"
            ...
            if result_err:
                ...
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/JxPath_buggy/errors/debate/error_log_{i}.txt", "w") as f:
                    f.write(result_err)
            ...
            defects4j compile > /home/lanweifrj/Test_Total/JxPath_fixed/results/debate/result_{i}.txt

            defects4j test >> /home/lanweifrj/Test_Total/JxPath_fixed/results/debate/result_{i}.txt
            """

            script_path = f"/home/lanweifrj/Test_Total/JxPath_fixed/scripts/configure_script_{i}.sh"
            with open(script_path, "w") as f:
                f.write(configure_script)
            result_cor, result_err = du.execute_script(script_path)
            if result_cor:
            ...
            if result_err:
                print("No." + str(i) + " error.\n")
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/JxPath_fixed/errors/debate/error_log_{i}.txt", "w") as f:
                    f.write(result_err)

            print("fixed done.")

        except:
            with open(f"/home/lanweifrj/Test_Total/JxPath_buggy/errors/debate/fatal_log_{i}.txt", "w") as f:
