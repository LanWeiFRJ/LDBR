    ...
    for i in index_list:
        try:
            ...
            if i < 30:
                ...
                defects4j compile >> /home/lanweifrj/Test_Total/Cli_buggy/results/result_{i}.txt

                defects4j test >> /home/lanweifrj/Test_Total/Cli_buggy/results/result_{i}.txt
                """
            else:
                configure_script = f"""
                defects4j checkout -p Cli -v {i}b -w /home/lanweifrj/Test_Total/Cli_buggy/Cli_{i}_buggy
            ...
            if i < 30:
                ...
                defects4j compile >> /home/lanweifrj/Test_Total/Cli_fixed/results/result_{i}.txt

                defects4j test >> /home/lanweifrj/Test_Total/Cli_fixed/results/result_{i}.txt
                """
            else:
                configure_script = f"""
                defects4j checkout -p Cli -v {i}f -w /home/lanweifrj/Test_Total/Cli_fixed/Cli_{i}_fixed
