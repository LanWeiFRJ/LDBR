...
if __name__ == "__main__":
    ...
    for i in index_list:
        try:
            _code3, response1, response2, response3, _response1, _response2, _response3 = du.iterator(url_list, i, model1, model2, "Cli")
            ...
            if i < 30:
                ...
                defects4j compile > /home/lanweifrj/Test_Total/Cli_buggy/results/debate/result_{i}.txt

                defects4j test >> /home/lanweifrj/Test_Total/Cli_buggy/results/debate/result_{i}.txt
                """
            else:
                configure_script = f"""
                rm -rf /home/lanweifrj/Test_Total/Cli_buggy/Cli_{i}_buggy
            ...
            if result_err:
                ...
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Cli_buggy/errors/debate/error_log_{i}.txt", "w") as f:
                    f.write(result_err)
            ...
            if i < 30:
                ...
                defects4j compile > /home/lanweifrj/Test_Total/Cli_fixed/results/debate/result_{i}.txt

                defects4j test >> /home/lanweifrj/Test_Total/Cli_fixed/results/debate/result_{i}.txt
                """
            else:
                configure_script = f"""
                rm -rf /home/lanweifrj/Test_Total/Cli_fixed/Cli_{i}_fixed
            ...
            if result_err:
                print("No." + str(i) + " error.\n")
                print(result_err)
                with open(f"/home/lanweifrj/Test_Total/Cli_fixed/errors/debate/error_log_{i}.txt", "w") as f:
                    f.write(result_err)

            print("fixed done.")

        except:
            with open(f"/home/lanweifrj/Test_Total/Cli_buggy/errors/debate/fatal_log_{i}.txt", "w") as f:
